...
//	E.push_back("4_461");
	...
	NameOfPlots.push_back("PMiss_0"); LabelOfPlots.push_back("(e,e'p)_{1p0#pi} P_{Miss} [GeV/c]"); OutputPlotNames.push_back("PMiss_AllEvents");
...
*/
					...
					PlotCanvas->SaveAs("myPlots/"+ext+nucleus[WhichNucleus]+"_" 
