...
void AccCorrXSec_OverlayPmissFig3a_e4nuPaper_1GeV() {
	...
	E.push_back("1_161"); LabelE.push_back("1.159 GeV"); DoubleE.push_back(1.161);	
...
//							legGenie->AddEntry(Plots[WhichFSIModel],"GENIE (Total)", "l"); 
					...
					PlotCanvas->SaveAs("../../../myPlots/pdf/"+xBCut[WhichxBCut]+"/"+version+nucleus[WhichNucleus]+"/"+E[WhichEnergy]+"/"
						...
						+E[WhichEnergy]+"_" +OutputPlotNames[WhichPlot]+"_SuSav2_AccCorrXSec_1GeV.pdf");

					PlotCanvas->SaveAs("../../../myPlots/pdf/"+xBCut[WhichxBCut]+"/"+version+nucleus[WhichNucleus]+"/"+E[WhichEnergy]+"/"
						+ext+"Fig3a_"+nucleus[WhichNucleus]+"_" 
						+E[WhichEnergy]+"_" +OutputPlotNames[WhichPlot]+"_SuSav2_AccCorrXSec_1GeV.eps");

					TFile* f = new TFile("Fig3a_PT_1GeV.root","recreate");
					gStyle->SetOptStat(0);	
					PlotCanvas->Write();
